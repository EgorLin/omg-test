...
{
    public class ChessQueenMoves : ChessUnitMoves, IChessUnitMovesProvider
    {
        ...
        public ChessQueenMoves(int chessGridSize) : base(chessGridSize)
        {
            _countSteps = _chessGridSize - 1;
        }
